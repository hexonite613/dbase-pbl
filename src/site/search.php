			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="contact.html">오시는 길</a>
						</li>
	...
	<section class="w3l-grids">
		<div class="grids-main py-5">
			<div class="container py-lg-3">
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						...
						<?php
							$title=$_GET['title'];
						?>	
							<h3 class="hny-title"><?=$title?> 검색 결과:</h3>
						</div>
					</div>
				</div>
				...
				<?php
					$movierequest="SELECT * from movie where name like '%$title%'";
				...
				?>
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="genre.html"><?php echo $board['name'] ?></a></h3>
						<div class="button-center text-center mt-4">
							<?php 
							if(isset($_SESSION['userid'])){
								?>
								<a href="../booking_test/movie_day.php?movie_id=<?=$board['movie_id']?>" class="btn watch-button">예매하기</a>
								<?php
							}
							else{
								?>
